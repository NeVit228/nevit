...
questions_list = []
questions_list.append(Question('Когда выйдет 21 обнова', 'a', 'б', 'в', 'г'))
questions_list.append(Question('Когда я получу магнит', 'a', 'б', 'в', 'г'))
questions_list.append(Question('когда я получу кирку', 'a', 'б', 'в', 'г'))
questions_list.append(Question('Когда я умру', 'a', 'б', 'в', 'г'))

question = QLabel('Когда выйдет 20 обнова?')

button1 = QRadioButton('Завтра')
button2 = QRadioButton('Через неделю')
button3 = QRadioButton('Через месяц')
button4 = QRadioButton('Никогда')
